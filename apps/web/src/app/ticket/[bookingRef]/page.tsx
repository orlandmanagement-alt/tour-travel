...
// Simulating QR Code generation string
const DUMMY_QR_PAYLOAD = "NSTR-84021|SARAH|CHEN|BROMO|20261215|PAID";

export default function ETicketBoardingPass({ params }: { params: { bookingRef: string } }) {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center py-12 px-4 print:bg-white print:p-0">
      ...
      {/* 
        Skeuomorphic Boarding Pass Design 
        print: styles ensure it looks perfect on A4
      */}
      <div className="max-w-3xl w-full flex flex-col items-center">
        ...
        {/* 
          The Ticket Body 
          Uses CSS drop-shadow instead of standard box-shadow for correct rendering around the jagged punch holes
        */}
           ...
           <div className="flex-1 p-8 md:p-10 relative">
              ...
              <div className="flex justify-between items-start mb-10 border-b border-slate-100 pb-6 relative z-10">
                 ...
                 <div className="text-right">
                    ...
                    <span className="px-3 py-1 bg-emerald-100 text-emerald-800 font-bold border border-emerald-200 rounded text-sm uppercase tracking-wider">
                      Confirmed
                    </span>
                 </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mb-10">
                 ...
                 <div>
                    ...
                    <h2 className="text-xl font-mono font-bold text-slate-900">{params.bookingRef}</h2>
                 </div>
                 <div className="col-span-2 md:col-span-1">
                    ...
                    <span className="text-sm font-bold text-red-500 mt-1 block">Meet at 00:30 AM (Midnight)</span>
                 </div>
              </div>

              <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 relative z-10">
                 <span className="text-xs uppercase tracking-widest text-slate-400 font-bold block mb-2">Tour Destination</span>
                 <h2 className="text-2xl font-extrabold text-slate-900 mb-1">Midnight Bromo Sunrise Premium</h2>
                 <p className="text-slate-600 font-medium">Pickup Point: Hotel Majapahit Surabaya • Guide: Budi (A012)</p>
                 ...
                 <div className="mt-4 pt-4 border-t border-slate-200 grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <span className="text-[10px] uppercase font-bold text-slate-400">Included Add-ons</span>
              ...
              {/* Instructions */}
              <div className="mt-8 text-xs text-slate-400 pr-10">
                 <p><b>Important:</b> Present this digital or printed boarding pass to your Tour Guide inside the Jeep. Bring warm clothing (jackets, gloves). Drones require exact permit validation at the national park entrance.</p>
              </div>
           </div>

           {/* 
             Divider punchline. 
             Creates the visually distinct 'tear-off' stub effect. 
           */}
           <div className="hidden md:flex flex-col items-center justify-between py-6 relative w-12 shrink-0">
             <div className="w-8 h-8 rounded-full bg-slate-100 absolute top-[-16px] print:bg-white border-b border-slate-200"></div>
             <div className="w-0.5 h-full border-l-2 border-dashed border-slate-300 print:border-slate-400"></div>
             <div className="w-8 h-8 rounded-full bg-slate-100 absolute bottom-[-16px] print:bg-white border-t border-slate-200"></div>
           </div>
           
           {/* Mobile Divider */}
           <div className="flex md:hidden items-center justify-between px-6 relative h-12">
             <div className="w-8 h-8 rounded-full bg-slate-100 absolute left-[-16px] border-r border-slate-200"></div>
             <div className="w-full h-0.5 border-t-2 border-dashed border-slate-300"></div>
             <div className="w-8 h-8 rounded-full bg-slate-100 absolute right-[-16px] border-l border-slate-200"></div>
           </div>

           {/* Right Section - The Stub / QR */}
           <div className="w-full md:w-80 p-8 md:p-10 bg-brand-primary text-white flex flex-col items-center justify-center shrink-0 print:bg-white print:text-black print:border-l print:border-slate-300">
              ...
              <div className="text-center w-full mb-8">
                 ...
                 <span className="block text-brand-primary-light font-mono text-sm print:text-slate-500">{params.bookingRef}</span>
              </div>

              {/* Mock QR generator (Replacing with a solid box for pure mockup) */}
              <div className="bg-white p-4 rounded-xl shadow-inner mb-6 w-48 h-48 flex items-center justify-center print:border-4 print:border-slate-800">
                 {/* This would be an actual QR canvas in production */}
                 <div className="w-full h-full bg-[url('https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/QR_code_for_mobile_English_Wikipedia.svg/1200px-QR_code_for_mobile_English_Wikipedia.svg.png')] bg-cover bg-no-repeat opacity-90 grayscale"></div>
              </div>
              ...
              <div className="text-center w-full">
                 ...
                 <p className="font-mono text-xs text-white opacity-80 break-all print:text-slate-800">{DUMMY_QR_PAYLOAD}</p>
              </div>
